    ...
    return function (t, cb) {
        ...
        if (anyCleanup &&
            ...
            if (cbRet_1 && typeof cbRet_1.then === "function") {
                return (_b = cbRet_1).then.apply(_b, __spread(Finally(function () { return callCleanup(cleanup_1); })));
            }
            else {
                var cleanupRet = callCleanup(cleanup_1);
                if (cleanupRet &&
...
function funnel(opts) {
    ...
    return function (fn) {
        ...
        var runner = function () {
            var _a;
            return (_a = Try(function () { return fn(shouldRetry, retry, shortcut); })).then.apply(_a, __spread(Finally(shortcut)));
        };
        return runner();
    };
}
