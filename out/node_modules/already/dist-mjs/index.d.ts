 ...
 */
export declare type IfPromise<P, T> = P extends Promise<infer U> ? T : never;
/**
 * IfNotPromise< P, T > returns <never> if P is a promise, otherwise returns T.
 */
export declare type IfNotPromise<P, T> = P extends Promise<infer U> ? never : T;
/**
 ...
 */
export declare type PromiseOf<P> = P extends Promise<infer U> ? P : Promise<P>;
/**
 ...
 */
export declare type EnsurePromise<P> = P extends Promise<infer U> ? P : never;
/**
 * Given type T, returns the same type T if it is *not* a Promise, otherwise
 * never.
 */
export declare type EnsureNotPromise<T> = T extends Promise<infer U> ? never : T;
...
export declare function funnel<T, B extends boolean = IfNotPromise<T, true>>(opts?: Partial<FunnelOptions>): Funnel<T>;
